...
exports.FormatInformation = exports.FORMAT_INFO_DECODE_LOOKUP = exports.FORMAT_INFO_MASK_QR = undefined;

var _qrcode = require('./qrcode.js');

var _errorlevel = require('./errorlevel.js');
...
var FormatInformation = function FormatInformation(formatInfo) {
  this.errorCorrectionLevel = _errorlevel.ErrorCorrectionLevel.forBits(formatInfo >> 3 & 0x03);
...
exports.FORMAT_INFO_MASK_QR = FORMAT_INFO_MASK_QR;
exports.FORMAT_INFO_DECODE_LOOKUP = FORMAT_INFO_DECODE_LOOKUP;
