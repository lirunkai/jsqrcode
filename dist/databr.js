...
var QRCodeDataBlockReader = function QRCodeDataBlockReader(blocks, version, numErrorCorrectionCode) {
  this.blockPointer = 0;
  this.bitPointer = 7;
  this.dataLength = 0;
  this.blocks = blocks;
  ...
  this.getDataLength = function (modeIndicator) {
    ...
    return this.getNextBits(_qrcode.qrcode.sizeOfDataLengthInfo[this.dataLengthMode][index]);
  };
